...
class Iface:
  ...
  def requestStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp):
    """
  ...
  def cancelStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, fileTime):
    """
  ...
  def getRequestedStreamStatus(self, sessionId, deviceId, channelId, mediaType, action, startTimestamp, endTimestamp):
    """
...
class Client(Iface):
  ...
  def requestStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp):
    ...
    Parameters:
     ...
     - endTimestamp
    """
    self.send_requestStreamForPlayback(sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp)
    return self.recv_requestStreamForPlayback()

  def send_requestStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp):
    self._oprot.writeMessageBegin('requestStreamForPlayback', TMessageType.CALL, self._seqid)
    args = requestStreamForPlayback_args()
    args.sessionId = sessionId
    args.deviceId = deviceId
    args.channelId = channelId
  ...
  def recv_requestStreamForPlayback(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = requestStreamForPlayback_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.coreExp is not None:
      raise result.coreExp
    raise TApplicationException(TApplicationException.MISSING_RESULT, "requestStreamForPlayback failed: unknown result");
  ...
  def cancelStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, fileTime):
    ...
    Parameters:
     ...
     - fileTime
    """
    self.send_cancelStreamForPlayback(sessionId, deviceId, channelId, mediaType, fileTime)
    return self.recv_cancelStreamForPlayback()

  def send_cancelStreamForPlayback(self, sessionId, deviceId, channelId, mediaType, fileTime):
    self._oprot.writeMessageBegin('cancelStreamForPlayback', TMessageType.CALL, self._seqid)
    args = cancelStreamForPlayback_args()
    args.sessionId = sessionId
    args.deviceId = deviceId
    args.channelId = channelId
    args.mediaType = mediaType
  ...
  def recv_cancelStreamForPlayback(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = cancelStreamForPlayback_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.coreExp is not None:
      raise result.coreExp
    raise TApplicationException(TApplicationException.MISSING_RESULT, "cancelStreamForPlayback failed: unknown result");
  ...
  def getRequestedStreamStatus(self, sessionId, deviceId, channelId, mediaType, action, startTimestamp, endTimestamp):
    ...
    Parameters:
     ...
     - endTimestamp
    """
    self.send_getRequestedStreamStatus(sessionId, deviceId, channelId, mediaType, action, startTimestamp, endTimestamp)
    return self.recv_getRequestedStreamStatus()

  def send_getRequestedStreamStatus(self, sessionId, deviceId, channelId, mediaType, action, startTimestamp, endTimestamp):
    self._oprot.writeMessageBegin('getRequestedStreamStatus', TMessageType.CALL, self._seqid)
    args = getRequestedStreamStatus_args()
    args.sessionId = sessionId
    args.deviceId = deviceId
    args.channelId = channelId
    args.mediaType = mediaType
  ...
  def recv_getRequestedStreamStatus(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = getRequestedStreamStatus_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.coreExp is not None:
      raise result.coreExp
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getRequestedStreamStatus failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["requestStreamForPlayback"] = Processor.process_requestStreamForPlayback
    self._processMap["cancelStreamForPlayback"] = Processor.process_cancelStreamForPlayback
    self._processMap["getRequestedStreamStatus"] = Processor.process_getRequestedStreamStatus
  ...
  def process_requestStreamForPlayback(self, seqid, iprot, oprot):
    args = requestStreamForPlayback_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = requestStreamForPlayback_result()
    try:
      result.success = self._handler.requestStreamForPlayback(args.sessionId, args.deviceId, args.channelId, args.mediaType, args.startTimestamp, args.endTimestamp)
    except CoreException, coreExp:
      result.coreExp = coreExp
    oprot.writeMessageBegin("requestStreamForPlayback", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_cancelStreamForPlayback(self, seqid, iprot, oprot):
    args = cancelStreamForPlayback_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = cancelStreamForPlayback_result()
    try:
      result.success = self._handler.cancelStreamForPlayback(args.sessionId, args.deviceId, args.channelId, args.mediaType, args.fileTime)
    except CoreException, coreExp:
      result.coreExp = coreExp
    oprot.writeMessageBegin("cancelStreamForPlayback", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getRequestedStreamStatus(self, seqid, iprot, oprot):
    args = getRequestedStreamStatus_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getRequestedStreamStatus_result()
    try:
      result.success = self._handler.getRequestedStreamStatus(args.sessionId, args.deviceId, args.channelId, args.mediaType, args.action, args.startTimestamp, args.endTimestamp)
    except CoreException, coreExp:
      result.coreExp = coreExp
    oprot.writeMessageBegin("getRequestedStreamStatus", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class beginStreamSession_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            ...
            self.allowedClientIpAddresses.append(_elem5)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.allowedClientIpAddresses is not None:
      ...
      for iter6 in self.allowedClientIpAddresses:
...
class keepStreamSessionAlive_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i18 in xrange(_size14):
            ...
            self.allowedClientIpAddresses.append(_elem19)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.allowedClientIpAddresses is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.allowedClientIpAddresses))
      for iter20 in self.allowedClientIpAddresses:
...
class getActiveOutboundStreamList_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(CommStructures.ttypes.StreamInfo, CommStructures.ttypes.StreamInfo.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'coreExp', (CoreException, CoreException.thrift_spec), None, ), # 1
  )
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i25 in xrange(_size21):
            _elem26 = CommStructures.ttypes.StreamInfo()
            _elem26.read(iprot)
...
class requestStreamForPlayback_args:
  """
  Attributes:
   - sessionId
   - deviceId
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'channelId', None, None, ), # 3
    (4, TType.STRING, 'mediaType', None, None, ), # 4
    (5, TType.STRING, 'startTimestamp', None, None, ), # 5
    (6, TType.STRING, 'endTimestamp', None, None, ), # 6
  )

  def __init__(self, sessionId=None, deviceId=None, channelId=None, mediaType=None, startTimestamp=None, endTimestamp=None,):
    self.sessionId = sessionId
    self.deviceId = deviceId
    self.channelId = channelId
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('requestStreamForPlayback_args')
    if self.sessionId is not None:
      oprot.writeFieldBegin('sessionId', TType.STRING, 1)
      oprot.writeString(self.sessionId)
      oprot.writeFieldEnd()
    if self.deviceId is not None:
      ...
      oprot.writeFieldEnd()
    if self.channelId is not None:
      oprot.writeFieldBegin('channelId', TType.STRING, 3)
      oprot.writeString(self.channelId)
      oprot.writeFieldEnd()
    if self.mediaType is not None:
      ...
      oprot.writeFieldEnd()
    if self.startTimestamp is not None:
      oprot.writeFieldBegin('startTimestamp', TType.STRING, 5)
      oprot.writeString(self.startTimestamp)
      oprot.writeFieldEnd()
    if self.endTimestamp is not None:
      oprot.writeFieldBegin('endTimestamp', TType.STRING, 6)
      oprot.writeString(self.endTimestamp)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class requestStreamForPlayback_result:
  """
  Attributes:
   - success
   - coreExp
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('requestStreamForPlayback_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
...
class cancelStreamForPlayback_args:
  """
  Attributes:
   - sessionId
   - deviceId
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'channelId', None, None, ), # 3
    (4, TType.STRING, 'mediaType', None, None, ), # 4
    (5, TType.LIST, 'fileTime', (TType.STRING,None), None, ), # 5
  )

  def __init__(self, sessionId=None, deviceId=None, channelId=None, mediaType=None, fileTime=None,):
    self.sessionId = sessionId
    self.deviceId = deviceId
    self.channelId = channelId
    self.mediaType = mediaType
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('cancelStreamForPlayback_args')
    if self.sessionId is not None:
      oprot.writeFieldBegin('sessionId', TType.STRING, 1)
      oprot.writeString(self.sessionId)
      oprot.writeFieldEnd()
    ...
    if self.fileTime is not None:
      oprot.writeFieldBegin('fileTime', TType.LIST, 5)
      oprot.writeListBegin(TType.STRING, len(self.fileTime))
      for iter48 in self.fileTime:
...
class cancelStreamForPlayback_result:
  """
  Attributes:
   - success
   - coreExp
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('cancelStreamForPlayback_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
...
class getRequestedStreamStatus_args:
  """
  Attributes:
   - sessionId
   - deviceId
  ...
  thrift_spec = (
    ...
    (6, TType.STRING, 'startTimestamp', None, None, ), # 6
    (7, TType.STRING, 'endTimestamp', None, None, ), # 7
  )

  def __init__(self, sessionId=None, deviceId=None, channelId=None, mediaType=None, action=None, startTimestamp=None, endTimestamp=None,):
    self.sessionId = sessionId
    self.deviceId = deviceId
    self.channelId = channelId
    self.mediaType = mediaType
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getRequestedStreamStatus_args')
    if self.sessionId is not None:
      oprot.writeFieldBegin('sessionId', TType.STRING, 1)
      oprot.writeString(self.sessionId)
      oprot.writeFieldEnd()
    ...
    if self.action is not None:
      ...
      oprot.writeFieldEnd()
    if self.startTimestamp is not None:
      oprot.writeFieldBegin('startTimestamp', TType.STRING, 6)
      oprot.writeString(self.startTimestamp)
      oprot.writeFieldEnd()
    if self.endTimestamp is not None:
      oprot.writeFieldBegin('endTimestamp', TType.STRING, 7)
      oprot.writeString(self.endTimestamp)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getRequestedStreamStatus_result:
  """
  Attributes:
   - success
   - coreExp
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i53 in xrange(_size49):
            _elem54 = CommStructures.ttypes.StreamFileDetails()
            _elem54.read(iprot)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getRequestedStreamStatus_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
